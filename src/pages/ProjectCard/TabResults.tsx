...
export default function TabResults({ data, editing, onChange, dark = true }: Props) {
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <FieldWrap label="Количество мероприятий" dark={dark}>
          <ViewOrInput
            editing={editing}
            type="number"
            min={0}
        ...
        <FieldWrap label="Количество участников мероприятий" dark={dark}>
          <ViewOrInput
            editing={editing}
            type="number"
            min={0}
        ...
        <FieldWrap label="Количество публикаций в СМИ и интернете" dark={dark}>
          <ViewOrInput
            editing={editing}
            type="number"
            min={0}
        ...
        <FieldWrap label="Количество просмотров публикаций" dark={dark}>
          <ViewOrInput
            editing={editing}
            type="number"
            min={0}
